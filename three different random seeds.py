...
seed_data = {
    ...
    3407: {"mAP50": 89.5, "mAP5095": 66.9, "Recall": 83.4, "Precision": 87.5},
    2026: {"mAP50": 89.0, "mAP5095": 67.0, "Recall": 84.4, "Precision": 88.4},
}
...
for seed in seeds:
    print(
        f"Seed {seed}: mAP@0.5={seed_data[seed]['mAP50']:.1f}%, "
